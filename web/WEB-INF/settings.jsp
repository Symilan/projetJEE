...
<fieldset id="tfa_Address" class="left_side">
    ...
    <div id="tfa_6980290244516">
        <div id="tfa_6980290243481-D" class="registration_paragraph">
            <label id="tfa_6980290243481-L" for="tfa_6980290243481">Pseudo :</label><br><input type="text" id="tfa_6980290243481" name="pseudo" value="${valeurs['pseudo']}" title="Pseudo" style="width: 100%">
        ...
        <div id="tfa_6980290243489-D" class="registration_paragraph">
            <label id="tfa_6980290243489-L" for="tfa_6980290243489">Ancien mot de passe :</label><br><input type="password" id="tfa_6980290243489" name="oldPassword" value="" title="Ancien mot de passe" style="width: 100%">
        </div>
        <div id="tfa_6980290243483-D" class="registration_paragraph">
            <label id="tfa_6980290243483-L" for="tfa_6980290243483">Nouveau mot de passe :</label><br><input type="password" id="tfa_6980290243483" name="password" value="" title="Nouveau mot de passe" style="width: 100%">
            <span class="erreur">${erreurs['password']}</span>
        </div>
        <div id="tfa_6980290243484-D" class="registration_paragraph">
            <label id="tfa_6980290243484-L" for="tfa_6980290243481">Confirmer nouveau mot de passe :</label><br><input type="password" id="tfa_6980290243484" name="passwordConfirmed" value="" title="Confirmer nouveau mot de passe" style="width: 100%">
        </div>
