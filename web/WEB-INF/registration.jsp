...
<fieldset id="tfa_Address" class="left_side">
    ...
    <div id="tfa_6980290244516">
        <div id="pseudo-D" class="registration_paragraph">
            <label id="pseudo-L" for="pseudo">Pseudo :</label><br><input type="text" id="pseudo" name="pseudo" value="${valeurs['pseudo']}" title="Pseudo" style="width: 100%" placeholder="ex : JeanJean_du_26">
            <span class="erreur">${erreurs['pseudo']}</span>
        </div>
        <div id="mailAdress-D" class="registration_paragraph">
            <label id="mailAdress-L" for="mailAdress-L">Adresse mail :</label><br><input type="text" id="mailAdress" name="mailAdress" value="${valeurs['mailAdress']}" title="Adresse mail" style="width: 100%" placeholder="ex : jeanjean@gmail.com">
